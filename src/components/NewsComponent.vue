...
export default {
  ...
  data() {
    return {
      newsData: [
        {
          title: "Digital Dollar Dreams: U.S. Explores the Pros and Cons of Central Bank Digital Currency (CBDC)",
          img: "img/news/1.jpg",
          tag: "Digital Dollar",
          des: [
            "As nations navigate the future of currency, the U.S. dives into the debate over a Digital Dollar.",
            "Uncover the potential impacts on the economy, international trade, and the way we conduct transactions in this groundbreaking move.",
            ,
          ],
        },
        {
          title: "Inflation Fears Surge: Global Economies Brace as Consumer Prices Reach Highest Point in a Decade",
          img: "img/news/2.jpg",
          tag: "Inflation",
          des: [
        ...
        {
          title: "Currency Wars Escalate: Nations Seek Competitive Edge in the Battle for Exchange Rates",
          img: "img/news/3.jpg",
          tag: "Currency Wars",
          des: [
            "Oki is a leading web design agency with an award-winning design team that creates innovative, effective websites that capture your brand, improve your conversion rates, and maximize your revenue to help grow your business and achieve your goals.",
